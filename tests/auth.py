...
from .base import BasePage  # Импортируем BasePage из модуля pages.base
from .locators import *  # Импортируем все локаторы из модуля pages.locators
