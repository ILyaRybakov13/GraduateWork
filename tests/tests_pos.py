...
import time
import pytest
from .auth import AuthPage, RegPage
from .registration_email import RegistrationEmail
...
class TestRegistration:
    ...
    def test_get_registration_valid(self, browser):
        ...
        with open(r"../tests/Settings.py", 'r', encoding='utf8') as file:
            lines = []
            for line in file.readlines():
                if 'valid_email' in line:
                    ...
                    lines.append(line)
        with open(r"../tests/Settings.py", 'w', encoding='utf8') as file:
